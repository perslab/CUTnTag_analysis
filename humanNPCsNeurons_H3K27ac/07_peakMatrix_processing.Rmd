...
VlnPlot(signac, features ="FrIP_seacrBinClusters" , group.by = "MULTI_ID")
```
...
```{r}
signac <- RunUMAP(signac, reduction = 'lsi_', dims = 2:ndim, reduction.name = 'lsi_umap')
...
signac <- FindClusters(object = signac, verbose = FALSE, algorithm = 3, resolution=PeakRes)
 table("binclusters"=signac$bin5000_snn_res.1,"peak_cluster"=signac$seurat_clusters)
...
VlnPlot(signac,
            features = c("nCount_bin5000",
                        ...
                        "duplicate",
                         ...
                         "nFeature_RNA", 
                      #   "HTO_margin",
                         "blacklist_region_fragments","FrIP_binClusters"),log = T
                         )
)
